 ...
 <table class="table table-hover">
    ...
    <tbody>
     <c:forEach items="${list}" var="list">
       ...
       <tr><td>${list.getMusicid()}</td><td>${list.getMusicname()}</td><td>${list.getFilmname()}</td><td>${list.getFilmlanguage()}</td></tr>
</c:forEach>
    </tbody>
  </table>
  </div>
...
<div align="center"><a href="/music/expand" class="btn btn-info btn-lg">
