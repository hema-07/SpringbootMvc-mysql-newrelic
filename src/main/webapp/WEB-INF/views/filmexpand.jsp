 ...
 <table class="table table-hover">
    ...
    <tbody>
     <c:forEach items="${list}" var="list">
       ...
       <td><a href="/film/edit/${list.getFilmid()}"><span class="glyphicon glyphicon-pencil"></span></a></td>
       <td><a href="/film/delete/${list.getFilmid()}"><span class="glyphicon glyphicon-trash"></span></a></td>
       </tr>
</c:forEach>
    </tbody>
  </table>
